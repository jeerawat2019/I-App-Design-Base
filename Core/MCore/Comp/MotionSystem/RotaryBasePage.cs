...
{
    public partial class RotaryBasePage : UserControl, IComponentBinding<RotaryBase>
    {
        private RotaryBase _axis = null;
        ...
        private Degrees GetDeltaTravel(int delPixels)
        {
            // First 10 pixels are reserved for single steps
            double counts = 0;
            double countRange = _axis.Range * _axis.MotorCountsPerDeg;
