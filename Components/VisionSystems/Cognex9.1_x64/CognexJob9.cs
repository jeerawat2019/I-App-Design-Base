...
{
    public class CognexJob9 : VisionJobBase
    {
        ...
        /// </summary>
        public CognexCamera9 CogCamera
        {
            get { return _cameraBase as CognexCamera9; }
        }
       ...
       private void CogToolGroup_OnRan(object sender, EventArgs e)
       {
            ...
            CognexCamera9 cogCam = CogCamera;
