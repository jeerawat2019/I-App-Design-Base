...
{
    public class CognexJob7 : VisionJobBase
    {
        ...
        /// </summary>
        public CognexCamera7 CogCamera
        {
            get { return _cameraBase as CognexCamera7; }
        }
        ...
        //private string _imageReceiver = string.Empty;

        /// <summary>
        /// The tool to receive image Format
        /// </summary>
        //[Browsable(true)]
        //[Category("Camera")]
        //public string ImageReceiver
        //{
        //    get { return _imageReceiver; }
        //    set { _imageReceiver = value; NotifyPropertyChanged(() => ImageReceiver); }
        //}
        ...
        //void OnRunComplete(object sender, EventArgs e)
        //{
