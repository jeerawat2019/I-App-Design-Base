...
namespace MCore.Comp.IOSystem.ModbusTcpIO
{
	/// <summary>
	...
	public class ModbusMaster
	{
		...
		public ModbusMaster(string ip, int port)
		{
			connect(ip, port);
		}
		...
		private void WriteAsyncData(byte[] write_data, int id)
		{
			...
			thrAsyListen.OnException	+= new ModbusMaster.ListenClass.ExceptionData(thrListen_OnException);
            thrAsyListen.OnResponseData += new ModbusMaster.ListenClass.ResponseData(thrListen_OnResponseData);
		...
		private byte[] WriteSyncData(byte[] write_data, int id)
		{
			...
			thrSynListen.OnException	+= new ModbusMaster.ListenClass.ExceptionData(thrListen_OnException);
			// --------------------------------------------------------------------
