...
namespace MCore.Comp.MotionSystem
{
    ...
    public class IAIScon:MotionSystemBase
    {
        ...
        public override void InitializeIDReferences()
        {
            ...
            //_modbusClient.ReceiveDataChanged += new ModbusClient.ReceiveDataChangedHandler(OnDataReceived);
             ClearAllFaults();
            ...
            try
            {
                ...
                for (int i = 0; i < retryCount; i++)
                {
                    ...
                    //{
                        ...
                        IsMoveSFTY_OnChanged(IsMoveSFTY);
        ...
        public override void MoveAbsAxis(RealAxis axis, MLengthSpeed speed, bool waitForCompletion)
        {
                ...
                try
                {
                    ...
                    //Add for disable SFTY for Allow Max Movement Speed
                    _waitDataRecived.Reset();
                    _modbusClient.WriteSingleCoil(IAIConstAddr.SFTY, false);
                    WaitDataReceived(ReadTimeOut);
