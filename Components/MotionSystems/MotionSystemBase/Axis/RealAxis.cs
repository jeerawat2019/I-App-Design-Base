...
{
    public class RealAxis : AxisBase
    {
        ...
        public enum eDir { Unknown, X, Y, Z, ReverseX, ReverseY, ReverseZ }
        ...
        public eDir Dir
        {
            get { return GetPropValue(() => Dir, eDir.Unknown); }
            set { SetPropValue(() => Dir, value); }
        }
        ...
        public bool IsXDir
        {
            get { return Dir == eDir.ReverseX || Dir == eDir.X; }
        }
        ...
        public bool IsYDir
        {
            get { return Dir == eDir.ReverseY || Dir == eDir.Y; }
        }
        ...
        public bool IsZDir
        {
            get { return Dir == eDir.ReverseZ || Dir == eDir.Z; }
        }

        /// <summary>
        /// The PSO Primary Axis
        /// </summary>
        [Browsable(true)]
        [Category("PSO")]
        [Description("The PSO Primary Axis")]
        public string[] PSOAxisKey
        {
            get { return GetPropValue(() => PSOAxisKey); }
            set { SetPropValue(() => PSOAxisKey, value); }
        }
        /// <summary>
        /// Default Speed
        /// </summary>
        [Browsable(true)]
        [Category("Axis")]
        public MillimetersPerSecond DefaultSpeed
        {
        ...
        /// </summary>
        [Category("Axis"), Description("The method used to home"), Browsable(true)]
        ...
        /// <summary>
        /// The PSO Encoder assignments
        /// </summary>
        [Browsable(true)]
        [Category("Axis")]
        [Description("The PSO Encoder assignments")]
        public string[] PSOEncoders
        {
            get { return GetPropValue(() => PSOEncoders); }
            set { SetPropValue(() => PSOEncoders, value); }
        }
        ...
        /// <summary>
        /// Delegate for RealAxis
        /// </summary>
        /// <param name="axis"></param>
        public delegate void delVoid_RealAxis(RealAxis axis);
        ...
        {
            IgnorePageList.Add(typeof(AxisBasePage));
            base.Initialize();
            Enabled = false;
            Homed = false;
        ...
        public void MoveAbs(Millimeters position, MillimetersPerSecond speed)
        {
        ...
        /// <param name="speed"></param>
        /// <param name="waitForCompletion"></param>
        public void MoveRel(Millimeters position, MillimetersPerSecond speed)
        {
            MoveRel(position, speed, true);
        }
        ...
        /// </summary>
        /// <param name="speed"></param>
        public virtual void SimulateMoveAbs(MLengthSpeed speed)
        {
